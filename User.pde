public class User {
    ...
    public void initializeTableDrawings(int rowNum, int columnNum, int x, int y, int wid, int hgt, String[] titles, String[][] labels, int borderWeight, int fontSize, color borderColor, color textColor) {
